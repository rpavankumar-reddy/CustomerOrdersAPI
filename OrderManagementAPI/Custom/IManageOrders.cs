...
namespace OrderManagementAPI.Custom
{
    public interface IManageOrders
    {
        ...
        OrderItems GetCustomerOrders(int orderId);
        ...
        OrderItems RemoveOrderItems(int orderId, string itemName, int quantity);
        OrderItems UpdateOrderItems(int orderId, string itemName, int quantity);
        OrderItems ClearCustomerOrderList(int orderId);
